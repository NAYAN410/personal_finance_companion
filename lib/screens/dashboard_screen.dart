...
class _DashboardScreenState extends ConsumerState<DashboardScreen>
          ...
          child: Column(
            children: [
              ...
              Row(
                ...
                children: [
                  _buildStatChip(Icons.arrow_upward_rounded, 'Income',
                      income, Colors.green.shade300),
                  Container(
                      width: 1, height: 30, color: Colors.white24),
                  _buildStatChip(Icons.arrow_downward_rounded, 'Expense',
                      expense, Colors.red.shade300),
                ],
              ),
            ],
          ),
  ...
  Widget _buildStatChip(IconData icon, String label, double amount,
      Color color) {
    return Column(
      children: [
        Row(
  ...
  Widget _buildQuickActions(BuildContext context) {
    return Padding(
      ...
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceEvenly,
        children: [
          _actionButton(context, Icons.add_card_rounded, 'Add',
              AppRoutes.addEditTransaction),
          _actionButton(context, Icons.list_alt_rounded, 'History',
              AppRoutes.transactions),
          _actionButton(context, Icons.insights_rounded, 'Insights',
              AppRoutes.insights),
        ],
      ),
    );
  ...
  Widget _buildSpendingInsightCard(List<Transaction> transactions,
      FinanceRepository repo, bool isDark) {
    ...
    final topCategory = categoryMap.entries.isEmpty
        ? null
        : categoryMap.entries.reduce((a, b) =>
    a.value > b.value ? a : b);
